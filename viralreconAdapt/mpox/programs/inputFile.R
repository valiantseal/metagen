...
inputDat$fastq_1<-paste0('./water_input/', inputDat$fastq_1)

inputDat$fastq_2<-paste0('./water_input/', inputDat$fastq_2)

write.table(inputDat, 'inputWater.csv', row.names = F, quote = F, sep=',')