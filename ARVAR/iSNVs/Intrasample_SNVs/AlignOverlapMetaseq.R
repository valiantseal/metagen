...
metaseq = read.csv("snvs_comb_res/metaseq_overlap_comb_derep_decont_covFilt_97_v2.csv")
...
metaList = getFilesList(inPath = "/home/ubuntu/extraVol/Viralrecon/covid/iSNVs_metaseq_2023-08-22/overlapSamples/output_4/variants/bowtie2", pattern = ".sorted.bam$")
...
prepFastqs = function(curPath) {
  ...
  targDir = paste0("IntraSnv_metaseq_overlap/", sampleName, "/")
