...
curDf = pd.read_csv("~/extraVol/ARVAR/classifier/Vivacilty_v1.0.1/process/EHC-C19-3914N-L3/sample_pos-filter.tsv", sep = "\t", low_memory=False)
bmread = pd.read_csv("~/extraVol/ARVAR/classifier/Vivacilty_v1.0.1/process/EHC-C19-3914N-L3/readCountParsed.tsv", sep = "\t", low_memory=False)

samplesList = os.listdir("/home/ubuntu/extraVol/ARVAR/classifier/Vivacilty_v1.0.1/process")
...
common_samples = checkSamples(path = '/home/ubuntu/extraVol/ARVAR/classifier/Vivacilty_v1.0.1/process', dfFilt = dfFilt)

curSampFilt = dfFilt[dfFilt["ExactSamp"] == "EHC-C19-3914N-L3"].reset_index(drop = True)

# deletion position should be +1
currAnnot = curDf[curDf["POS"] == 22204]
currAnnot = bmread[bmread["position"] == 22204]
