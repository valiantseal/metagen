...
counts <- Read10X_h5("/home/flyhunter/Wang/data/control/extracted/filtered_feature_bc_matrix.h5")
metadata <- read.csv(
  file = "/home/flyhunter/Wang/data/control/per_barcode_metrics.csv",
  header = TRUE,
  row.names = 1
)
