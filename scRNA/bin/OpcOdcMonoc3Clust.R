...
cds <- reduce_dimension(cds)
conStr<-plot_cells(cds, color_cells_by="group", label_cell_groups=FALSE)

ggsave(paste0('OPC_ODC_MonocClust_ContrStress_', curDate, '.jpeg'), plot = conStr, height = 12, width = 12, units = 'in', dpi = 300)
...
ggsave(paste0('OPC_ODC_MonocClust_Root2_', curDate, '.jpeg'), plot = psedPlot, height = 12, width = 12, units = 'in', dpi = 300)
ggsave(paste0('OPC_ODC_MonocClust_Root2_Box_', curDate, '.jpeg'), plot = psedBox, height = 12, width = 12, units = 'in', dpi = 300)
write.csv(medTimes, paste0('OPC_ODC_MonocClust_Root2_sum_', curDate, '.csv'), row.names = F)
