...
#ggsave(paste0('OPC_ODC_MonocClust_85PC_Root2_StressVsContr', curDate, '.jpeg'), plot = conStr, height = 12, width = 12, units = 'in', dpi = 300)
...
#ggsave(paste0('OPC_ODC_MonocClust_85PC_Root2_ColClust', curDate, '.jpeg'), plot = plotClust, height = 12, width = 12, units = 'in', dpi = 300)
...
#ggsave(paste0('OPC_ODC_MonocClust_85PC_Root2_', curDate, '.jpeg'), plot = psedPlot, height = 12, width = 12, units = 'in', dpi = 300)
...
write.csv(marker_test_res, paste0(targDir, 'OPC_ODC_MonocClust_85PC_clusterMarkersTop100_', curDate, '.csv'), row.names = F)
write.csv(marker_test_group, paste0(targDir,'OPC_ODC_MonocClust_85PC_groupMarkersTop100_', curDate, '.csv'), row.names = F)
...
write.csv(coefFiltr, paste0(targDir,'OPC_ODC_MonocClust_85PC_top100G_TimeCor_', curDate, '.csv'), row.names = F)
...
write.csv(coefAdjGrFiltr, paste0(targDir, 'OPC_ODC_MonocClust_85PC_top100G_adjGr_TimeCor_', curDate, '.csv'), row.names = F)
# compare models
modelComp<-compare_models(genes_adjGroup, gene_fits)

write.csv(modelComp, paste0(targDir,'OPC_ODC_MonocClust_85PC_top100G_TimeCor_ModelComp_', curDate, '.csv'), row.names = F)