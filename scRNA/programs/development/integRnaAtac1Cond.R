...
stressPeak <- readRDS('../data/atacAllFiltMacs2_control')
...
targetDir<-'Atac_Rna_coverPlots/Control_only/macs2/'
...
targetDir<-'Atac_Rna_coverPlots/Control_only/original_peaks/'
